...
SELECT staff.staff_id, staff.first_name, staff.last_name, COUNT(payment.amount) AS total_amount
FROM staff
...
WHERE (film.title LIKE "K%" OR film.title LIKE "O%") AND film.language_id = (SELECT language.language_id FROM language WHERE language.name= "English");
